...
const CONFIG = {
  ...
  lockIconPath: "/icon-v3.png", // The specific lock icon you mentioned
...
// --- LIBRARY GRID WITH LOCKING LOGIC (UPDATED FOR HONOR SYSTEM) ---
                        ...
                        return (
                            ...
                            >
                                <div className={`aspect-[2/3] w-full bg-zinc-900 border rounded-sm relative overflow-hidden transition-all shadow-lg ${isUnlocked ? 'border-stone-800 group-hover:border-amber-600/50 group-hover:shadow-amber-900/10' : 'border-stone-900'}`}>
                                    ...
                                    {!isUnlocked && (
                                        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/80 backdrop-blur-sm transition-all hover:bg-black/70">
                                    ...
                                    <img 
                                        src={book.cover} 
                                        alt={book.title} 
                                        className={`absolute inset-0 w-full h-full object-cover transition-all duration-700 ${isUnlocked ? 'opacity-80 group-hover:opacity-100 group-hover:scale-105' : 'opacity-30 grayscale'}`} 
